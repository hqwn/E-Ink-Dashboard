...
If you copy what I made, you can copy all of the code and paste it into your Arduino IDE; CHANGE THE WIFI AND PASSWORD in the web server script to yours, and flash it. You can check the IP it's on through the serial monitor at 11,5200 baud. That's all! If you do all that, it should all work :) 
